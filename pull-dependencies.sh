...
pullparmesan 'commons-dbcp2-2.1.1.jar'
pullparmesan 'commons-dbcp2-2.1.1-javadoc.jar'
pullparmesan 'commons-logging-1.2.jar'
pullparmesan 'commons-logging-1.2-javadoc.jar'
pullparmesan 'commons-pool2-2.4.2.jar'
pullparmesan 'commons-pool2-2.4.2-javadoc.jar'
pullparmesan 'mysql-connector-java.jar'
